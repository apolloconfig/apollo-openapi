...
"${OPENAPI_GENERATOR[@]}" generate \
  ...
  --additional-properties=projectName=apollo-openapi,packageVersion=0.3.1
...
"${OPENAPI_GENERATOR[@]}" generate \
  ...
  -g typescript-fetch \
  -o "$TS_DIR" \
  --additional-properties=npmName=apollo-openapi,npmVersion=0.3.1,typescriptThreePlus=true
...
"${OPENAPI_GENERATOR[@]}" generate \
  ...
  --additional-properties=groupId=com.apollo,artifactId=apollo-openapi-client,artifactVersion=0.3.1,packageName=com.apollo.openapi.client
...
"${OPENAPI_GENERATOR[@]}" generate \
  ...
  --additional-properties=packageName=apollo-openapi,packageVersion=0.3.1
