...
"${OPENAPI_GENERATOR[@]}" generate \
  ...
  --additional-properties=projectName=apollo-openapi,packageVersion=0.3.4
...
"${OPENAPI_GENERATOR[@]}" generate \
  ...
  -g typescript-fetch \
  -o "$TS_DIR" \
  --additional-properties=npmName=apollo-openapi,npmVersion=0.3.4,typescriptThreePlus=true
...
"${OPENAPI_GENERATOR[@]}" generate \
  ...
  --additional-properties=groupId=com.apollo,artifactId=apollo-openapi-client,artifactVersion=0.3.4,packageName=com.apollo.openapi.client
...
"${OPENAPI_GENERATOR[@]}" generate \
  ...
  -o "$SPRING_BOOT2_DIR" \
  --additional-properties hideGenerationTimestamp=true \
  --additional-properties=groupId=com.apollo,artifactId=apollo-openapi-server,artifactVersion=0.3.4,packageName=com.apollo.openapi.server,basePackage=com.apollo.openapi.server,configPackage=com.apollo.openapi.server.config,modelPackage=com.apollo.openapi.server.model,apiPackage=com.apollo.openapi.server.api,library=spring-boot,java8=true,interfaceOnly=false,delegatePattern=true,useTags=true
...
"${OPENAPI_GENERATOR[@]}" generate \
  ...
  --additional-properties=packageName=apollo-openapi,packageVersion=0.3.4
