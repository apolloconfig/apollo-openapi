...
class OpenUserDTO(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["username", "userDisplayName", "password", "email", "enabled", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["username", "userDisplayName", "password", "email", "enabled", ], str]):
