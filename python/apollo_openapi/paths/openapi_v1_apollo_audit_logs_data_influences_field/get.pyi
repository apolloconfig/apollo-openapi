...
RequestRequiredQueryParams = typing_extensions.TypedDict(
    ...
    {
        'entityName': typing.Union[EntityNameSchema, str, ],
...
class BaseApi(api_client.Api):
    @typing.overload
    def _find_audit_data_influences_by_field_oapg(
        self,
...
class FindAuditDataInfluencesByField(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def find_audit_data_influences_by_field(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def find_audit_data_influences_by_field(
        ...
        return self._find_audit_data_influences_by_field_oapg(
