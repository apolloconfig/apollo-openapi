...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'expires': typing.Union[ExpiresSchema, str, ],
    },
    total=False
)
...
request_query_expires = api_client.QueryParameter(
    name="expires",
    style=api_client.ParameterStyle.FORM,
    schema=ExpiresSchema,
    explode=True,
)
# body param
...
class CreateConsumer(BaseApi):
    ...
    def create_consumer(
        ...
        return self._create_consumer_oapg(
            body=body,
