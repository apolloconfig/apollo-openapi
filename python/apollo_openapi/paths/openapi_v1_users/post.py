...
request_query_is_create = api_client.QueryParameter(
    name="isCreate",
...
request_body_open_user_dto = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_or_update_user_oapg(
        self,
    ...
    def _create_or_update_user_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_open_user_dto.serialize(body, content_type)
...
class CreateOrUpdateUser(BaseApi):
    ...
    def create_or_update_user(
        ...
        return self._create_or_update_user_oapg(
            body=body,
