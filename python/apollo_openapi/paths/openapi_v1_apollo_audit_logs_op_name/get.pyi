...
# Query params
OpNameSchema = schemas.StrSchema
...
RequestRequiredQueryParams = typing_extensions.TypedDict(
    ...
    {
        'opName': typing.Union[OpNameSchema, str, ],
    }
)
...
request_query_op_name = api_client.QueryParameter(
    name="opName",
...
class BaseApi(api_client.Api):
    @typing.overload
    def _find_audit_logs_by_op_name_oapg(
        self,
...
class FindAuditLogsByOpName(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def find_audit_logs_by_op_name(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def find_audit_logs_by_op_name(
        ...
        return self._find_audit_logs_by_op_name_oapg(
